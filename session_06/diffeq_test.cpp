...
main (void)
{
  ...
  y_euler[0] = exact_answer (1., params_ptr);
  y_rk4[0] = exact_answer(1., params_ptr);
  ...
  for (double h = 0.1; h>=10e-14;h=h*0.1)
  {

  y_euler[0] = exact_answer (t, params_ptr);
  y_rk4[0] = exact_answer(t, params_ptr);
