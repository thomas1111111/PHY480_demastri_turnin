...
RandomWalk::RandomWalk (double x0, double y0, double lower, double upper)
{
  ...
  lower_limit = lower;	// lower limit of uniform range 
  upper_limit = upper;	// upper limit of uniform range 
