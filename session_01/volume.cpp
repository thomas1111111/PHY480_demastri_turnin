...
// 
//
//  This program calculates the volume of a circle, given the radius.
//
...
main ()
{
  ...
  std::cout << "Enter the radius of a sphere: ";	// ask for radius
  std::cin >> radius;

  double volume = 4*(pi/3) * radius * radius * radius;	// standard volume formula
  std::cout << "radius = " << radius << ",  volume = " << volume <<std::endl;
