...
main ()
{
  ...
  cout << "Please Enter your chosen dimension: ";
  cin >> dimension;


  ofstream myout ("eigen_basis_dimension_" + to_string (dimension) + "_bho_" +
		  to_string (b_ho) + ".dat");
  ...
  for (double r = 0.; r < 10.01; r += 0.05)
      ...
      for (int i = 0; i < dimension; i++)
	{
      ...
      double u_r = ho_eigenvalue(1,0,b_ho,r) * ho_radial (1, 0, b_ho, r);
     
      myout << setw (8) << r << "   " << setw (8) << u_r << endl;
